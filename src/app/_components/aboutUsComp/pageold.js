    ...
    <>
      <div className={`${poppins.className} min-h-screen text-white relative`}>
        ...
        <div className="absolute inset-0 -z-20" aria-hidden>
          <div
            style={{
              //selected designs so far
              // background:"linear-gradient(135deg, #8547c6 25%, #b845c1 62%, #ab5d8a 95%)",
              // background:"linear-gradient(225deg, #007cc2 20%, #5865f2)",
              // background: "linear-gradient(90deg, #240b36 0%, #c3147c 100%)",

              background:
                "linear-gradient(135deg, #007cc2 10%,#b845c1 39%,#ab5d8a 95%)",
            }}
            // className="w-full h-full bg-gradient-to-r from-blue-500 to-purple-500 opacity-80"
