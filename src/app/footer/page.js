...
const Footer = () => {
  ...
  <p className="font-bold text-white/75 transform transition-all duration-700 ease-out animate-fade-in-up [animation-delay:400ms] hover:translate-x-2 hover:text-white/90 p-3 rounded-lg hover:bg-white/5 backdrop-blur-sm border border-transparent hover:border-white/10">
    Phone:{" "}
    <a 
